  ...
  return (
    <section className="snap-section" style={{ background: "var(--bg)" }}>
      <div className="flex flex-col items-center px-6">
        <h1 className="text-[clamp(1.8rem,7vw,6rem)] font-black leading-[1] tracking-tight uppercase text-center">
          Photography
        </h1>
        <h2 className="text-[clamp(1.8rem,7vw,6rem)] font-black leading-[1] tracking-tight uppercase text-center">
